...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    <div id="divMainContainer" class="MarginContainer">
        ...
        <asp:Panel runat="server" ID="pnlType">
            <div id="divType" class="MarginContainer">
        ...
        <asp:Panel runat="server" ID="pnlTitle">
            <div id="divTitle" class="MarginContainer">
        ...
        <asp:Panel runat="server" ID="pnlGenre">
            <div id="divGenre" class="MarginContainer">
        ...
        <asp:Panel runat="server" ID="pnlKeyword">
            <div id="divKeyword" class="MarginContainer">
        ...
        <asp:Panel runat="server" ID="pnlPerson">
            <div id="divPerson" class="MarginContainer">
        ...
        <asp:Panel runat="server" ID="pnlResults">
            <div id="divResults" class="MainContainer">
